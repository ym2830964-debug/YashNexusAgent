    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10 text-slate-100">
      ...
      <div className="border-b border-slate-800 pb-6 space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-950/60 border border-purple-800 text-purple-300 text-xs font-mono">
          ...
          <span>System Architecture & Intelligence Flow</span>
        </div>
        <h1 className="text-3xl font-extrabold tracking-tight font-[#Space_Grotesk]">
          The Interview Agent <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">Architecture</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          <h2 className="text-sm font-mono text-slate-400 uppercase tracking-wider flex items-center gap-2">
            ...
            7-Stage Intelligent Pipeline (Click any node to inspect)
          </h2>
                ...
                <div key={node.id} className="relative">
                  ...
                  <div
                    ...
                    className={`cursor-pointer rounded-2xl p-4 transition-all duration-300 border shadow-lg flex items-center justify-between gap-4 ${
                      isSelected
                        ? 'bg-gradient-to-r from-blue-950/90 via-slate-900 to-purple-950/90 border-cyan-400/80 shadow-cyan-500/20 scale-[1.02]'
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-mono font-bold text-slate-400">STAGE 0{index + 1}</span>
                    ...
                    <div className="flex items-center gap-3 font-mono text-xs">
                      <span className="px-2 py-0.5 rounded bg-slate-900 border border-slate-800 text-[10px] text-cyan-400">
                        {node.latencyMs}ms
                      </span>
